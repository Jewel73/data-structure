...
I have started 100 days code challenge on 26 july 2023. I am going to be preparing myself for coding interview

 > Solved Problem : Binary Search / Array

 ## Day 1 To Day 10 : Array, Binary Search, Matrix
...
- Find missing number in sorted array: n - (actualIndex +1)
- Return First Index if array index outside range: start % len;
- Root find : multiply mid until the given number found.
